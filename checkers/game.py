...
class Checkers:
    ...
    def __init__(
        ...
        assert (
            turn in Checkers.all_players
        ), "It must be either `black` or `white`'s turn"
    ...
    def move(self, from_sq, to_sq, skip_check=False):
        ...
        if len(all_next_moves) == 0:
            ...
            winner = None
        return self.board, self.turn, self.last_moved_piece, all_next_moves, winner, num_captured, captured_type
